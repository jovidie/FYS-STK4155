...
def ols_regression(x, y, z, degree):
    """Ordinary least squares regression analysis using franke data, evaluated 
...
def ridge_regression(x, y, z, degree, lambdas):
    """Ridge regression analysis using franke data, evaluated by mean square 
    error and R2 score.
...
def lasso_regression(x, y, z, degree, lambdas):
    """Lasso regression analysis using franke data, evaluated by mean square 
    error and R2 score.
